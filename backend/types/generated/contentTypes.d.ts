...
export interface ApiOpinionOpinion extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Rese\u00F1as de usuarios con moderaci\u00F3n';
    displayName: 'Opinion';
    pluralName: 'opinions';
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variantes: Schema.Attribute.Component<'inventario.variantes', true>;
  };
}
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    ciudad_facturacion: Schema.Attribute.String;
    codigoPostal: Schema.Attribute.String;
    confirmationToken: Schema.Attribute.String & Schema.Attribute.Private;
    confirmed: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    cp_facturacion: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    direccion: Schema.Attribute.String;
    direccion_facturacion: Schema.Attribute.String;
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
    ...
    numero_facturacion: Schema.Attribute.String;
    opinions: Schema.Attribute.Relation<'oneToMany', 'api::opinion.opinion'>;
    ...
    provincia_facturacion: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
    role: Schema.Attribute.Relation<
      'manyToOne',
